...
import {
  mudarSenhaFormSchema,
  mudarSenhaFormSchemaZod,
} from "@/lib/schemas/mudar-senha";
        ...
        <Row width="100%" height="76vh" alignItems="center">
          ...
          >
            ...
            <Typography
              ...
              mb={theme.space.s10}
            >
              Insira sua senha atual e escolha uma nova senha para proteger sua
              conta.
            </Typography>
            ...
            <Typography
              ...
              mb={theme.space.s9}
            >
              Certifique-se de que tenha pelo menos 8 caracteres, incluindo um
              número e uma letra minúscula
            </Typography>

            <Button disabled={!isValid} fontSize={"12px"} width="80%">
              Atualizar senha
            </Button>
          </Column>
        </Row>
